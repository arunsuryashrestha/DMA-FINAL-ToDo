...
import com.example.android.todoapp.custom.action.NavigationViewActions;
...
import static com.example.android.todoapp.TestUtils.getToolbarNavigationContentDescription;
...
public class AppNavigationTest {
    ...
    private void openTasksScreen() {
        ...
        onView(withId(R.id.nav_view))
                .perform(NavigationViewActions.navigateTo(R.id.list_navigation_menu_item));
    }
